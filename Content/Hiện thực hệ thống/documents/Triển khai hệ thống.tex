...
\input{Content/Hiện thực hệ thống/documents/Triển khai hệ thống/Triển khai Frontend.tex}
\subsection{Triển khai phần Backend của hệ thống}
\input{Content/Hiện thực hệ thống/documents/Triển khai hệ thống/Triển khai Backend.tex}
\subsection{Triển khai phần Database của hệ thống}
\input{Content/Hiện thực hệ thống/documents/Triển khai hệ thống/Triển khai Database.tex}
