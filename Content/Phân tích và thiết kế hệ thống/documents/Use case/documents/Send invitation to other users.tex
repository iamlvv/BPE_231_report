\subsubsection{Send invitation to other users}
...
\hline
\textbf{Use-case name}    & Send invitation to other users
\\ \hline
\textbf{Actor}            & Workspace member
\\ \hline
\textbf{Description}      & Người dùng có thể gửi lời mời tham gia workspace cho người dùng trong hệ thống. 
\\ \hline
\textbf{Trigger}          & Không
\\ \hline
