...
\begin{tabular}{|p{3cm}|p{11cm}|}
  ...
  \\ \hline
  \textbf{Post-conditions}   & Người dùng thành công thay đổi giá trị thay đổi giá trị health/feasibility/strategic importance của process version, những giá trị này sẽ được sử dụng để khởi tạo process portfolio.
  \\ \hline
  \textbf{Normal flow} &
    \begin{enumerate}
  ...
  \textbf{Alternative flows} & 
    \begin{tabular}{p{10cm}}
      3. Người dùng chọn “Activate” để kích hoạt trạng thái active của process version này.
      \\ 
      4. Người dùng không nhập thông tin
      \begin{enumerate}
