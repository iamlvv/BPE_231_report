...
\hline
\textbf{Use-case name}    & Create new project
\\ \hline
\textbf{Actor}            & Workspace owner, workspace member
\\ \hline
\textbf{Description}      & Workspace owner có thể tạo project trong Workspace 
\\ \hline
\textbf{Trigger}          & Không
\\ \hline
\textbf{Pre-conditions}   & Workspace owner đã đăng nhập vào hệ thống, hiện tại đang ở giao diện workspace người dùng muốn tạo project. Người dùng có quyền hạn của editor hoặc owner.
\\ \hline
