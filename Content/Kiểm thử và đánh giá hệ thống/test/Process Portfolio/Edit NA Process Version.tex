\subsubsection{Khởi tạo process portfolio: Workspace có process version bị khuyết giá trị}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|p{3cm}|p{1.5cm}|p{0.5cm}|p{4cm}|p{4cm}|>{\centering\arraybackslash}p{1cm}|}
            ...
            \multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}Khởi tạo process \\ portfolio: \\ Workspace có \\ process version bị \\ khuyết giá trị\end{tabular}} &
            ...
            Hệ thống mở modal khởi tạo Process portfolio, hiển thị danh sách những process version còn bị khuyết giá trị yêu cầu người dùng bổ sung. &
            Đạt \\ \cline{3-6} \hline
        \end{tabular}
    }
    \caption{Test case Khởi tạo process portfolio: Workspace có process version bị khuyết giá trị}
\end{table}
