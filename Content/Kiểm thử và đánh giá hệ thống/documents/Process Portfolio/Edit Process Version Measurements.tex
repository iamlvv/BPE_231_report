\subsection{Thay đổi giá trị của process version trong quản lý process portfolio}
...
\subsection{Người dùng thực hiện thay đổi giá trị của process version trong quản lý process portfolio với kiểu dữ liệu chữ cái/ký tự đặc biệt}
...
\subsection{Người dùng thực hiện thay đổi giá trị của process version trong quản lý process portfolio: Thay đổi giá trị cycle time/cost với kiểu dữ liệu số thập phân}
